...
/*============================================================================
  PROMEDIO UDT
  Se obtiene el incremento promedio desde GB_INCREMENTO_MERITO
  para la clave CN (China)
============================================================================*/
L_UDT_PROM = TO_NUMBER(GET_TABLE_VALUE('GB_INCREMENTO_MERITO', 'Incremento_Promedio', 'CN'))

l_log = SET_LOG('Promedio UDT CH: ' || TO_CHAR(L_UDT_PROM))
