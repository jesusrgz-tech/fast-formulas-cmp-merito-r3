    /******************************************************************************
    * *
    * FORMULA NAME      : GB_CMP_BONO_MERITO_R3                                   *
    ...
    ******************************************************************************/
    ...
    /* ========== VALIDAR CALIFICACION EN UDT ========== */
        ...
        L_APLICA_BONO = GET_TABLE_VALUE('GB_CMP_CALIF_BONO_R3', 'Aplica_Bono', L_EVAL_TXT)
    ...
    l_log = SET_LOG('Key UDT: [' || L_LEGAL_EMPLOYER || ']')
        ...
        L_DIAS_BONO = TO_NUMBER(GET_TABLE_VALUE('GB_CMP_DIAS_BONO_BASE_EVALUACION_R3', 'Calificacion', L_LEGAL_EMPLOYER))
    ...
    l_log = SET_LOG('*** RESULTADO GB_CMP_BONO_MERITO_R3: ' || TO_CHAR(L_DEFAULT_VALUE) || ' ***')
    RETURN L_DEFAULT_VALUE